...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.register({ username, password, age: parseInt(age) });
      navigate('/login');
    } catch (err) {
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type="number" placeholder="Возраст" value={age} onChange={(e) => setAge(e.target.value)} required style={styles.input} />
